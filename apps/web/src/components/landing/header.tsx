import { Button, buttonVariants } from "@opium/ui/components/button";
import { MenuToggleIcon } from "@opium/ui/components/menu-toggle-icon";
import { useScroll } from "@opium/ui/hooks/use-scroll";
      ...
      >
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <Button variant="outline">
            <a
              href="https://github.com/aBgAmeuR"
