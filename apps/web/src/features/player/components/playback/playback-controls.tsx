...
export function ProgressBar() {
  ...
  return (
    <div className="mt-1 flex w-full items-center">
      ...
      <div
        ref={progressBarRef}
        className="relative mx-2 h-1 grow cursor-pointer rounded-full bg-[#3E3E3E]"
...
export function PlaybackControls() {
  ...
  useEffect(() => {
    if ('mediaSession' in navigator && currentTrack) {
      ...
      return () => {
        currentAudio?.removeEventListener('timeupdate', updatePositionState);
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 flex items-center justify-between border-t border-[#282828] bg-[#181818] p-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))]">
      <audio ref={audioRef} />
      <TrackInfo />
