...
export const SidebarRightIcon = (props: Props) => (
	<svg fill="none" viewBox="0 0 24 24" {...props}>
		<title>Sidebar Right</title>
		<path
			d="M3.24172 4.31802C1.99949 5.63604 1.99949 7.75736 1.99949 12C1.99949 16.2426 1.99949 18.364 3.24172 19.682C4.48395 21 6.48329 21 10.482 21C12.133 21 13.4432 21 14.5 20.9072L14.5 3.09278C13.4432 3 12.133 3 10.482 3C6.48329 3 4.48395 3 3.24172 4.31802Z"
			fill="currentColor"
			opacity="0.2"
		/>
		<path
